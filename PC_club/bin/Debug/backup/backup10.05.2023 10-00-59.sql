...
INSERT INTO `rent`(`id_rent`,`idclients`,`out_data_rent`,`time`,`idpc`,`idemployees`,`price`) VALUES(53,10,'10.05.2023 10:13:24','50',5,2,25);
...
INSERT INTO `sale_minuts`(`id_sale`,`minuts`,`sale`) VALUES(4,1500,75);
...
INSERT INTO `clients`(`id_clients`,`surname`,`name`,`patronymic`,`dateofbirth`,`minutes`,`idsale`) VALUES(10,'Лебедев','Артем','Сергеевич','2023-05-09 00:00:00',2491,4),(11,'Перистов','Дмитрий','Сергеевич','2023-05-09 00:00:00',1181,NULL);
...
-- Dump completed on 2023-05-10 10:01:00
-- Total time: 0:0:0:0:119 (d:h:m:s:ms)
