...
INSERT INTO `employees`(`id_employees`,`position`,`surname`,`name`,`patronymic`,`dateofbirth`,`phone`) VALUES(2,'пользователь','Иванов','Иван','Иванович','2023-02-07 00:00:00',845964586),(3,'пользователь','Смирновв','Иван','Иванович','2000-02-02 00:00:00',583493478),(4,'пользователь','Перистов','Иван','Иванович','2000-02-02 00:00:00',583493478);
...
INSERT INTO `pc`(`id_pc`,`number_pc`,`lastdate`,`cost`,`id_rate`) VALUES(5,1,'2023-02-14 00:00:00',1,3),(6,2,'2023-02-14 00:00:00',1,2);
...
INSERT INTO `rent`(`id_rent`,`idclients`,`out_data_rent`,`time`,`idpc`,`idemployees`,`price`) VALUES(29,4,'02.05.2023 21:39:36','100',5,3,160);
...
INSERT INTO `clients`(`id_clients`,`surname`,`name`,`patronymic`,`dateofbirth`,`minutes`,`idsale`) VALUES(4,'Перистов','Дмитрий','Сергеевич','2004-03-03 00:00:00',1303,2),(5,'Лебедев','Артем','Сергеевич','2003-07-16 00:00:00',0,NULL);
...
-- Dump completed on 2023-05-02 20:20:37
